            ...
            <table class="table mx-auto container-fluid" id="datatable">
                <thead>
                    <tr>
                        ...
                        <th scope="col" onclick="sortTable(3)">ID VEHICULO</th>
                        <th scope="col" onclick="sortTable(4)">PLACA VEHICULO</th>
                        <th scope="col" onclick="sortTable(5)">ID TIPO</th>
                        <th scope="col" onclick="sortTable(6)">TIPO</th>
            ...
            <form method="POST" id="modalTabForm">
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <select class="form-select" name="vehiculo_id" id="select_vehiculo">
...
<jsp:include page="components/foot.jsp">
    <jsp:param  name="js" value="<script src=\"../../public/js/conductor_vehiculo.js\"></script>"/>
</jsp:include>
