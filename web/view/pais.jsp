...
<jsp:include page="components/head.jsp">
    <jsp:param  name="nombre" value="Pais"/>
</jsp:include>
                ...
                <table class="table mx-auto container-fluid" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" onclick="sortTable(1)">ISO</th>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="form-floating mb-3 col">
                            ...
                            <input type="text" class="form-control"  placeholder="Ingresar iso" name="iso">
...
<jsp:include page="components/foot.jsp">
    <jsp:param  name="js" value="<script src=\"../../public/js/pais.js\"></script>"/>
</jsp:include>