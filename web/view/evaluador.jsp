            ...
            <table class="table mx-auto container-fluid" id="datatable">
                <thead>
                    <tr>
                        ...
                        <th scope="col" onclick="sortTable(3)">ID EMPRESA</th>
                        <th scope="col" onclick="sortTable(4)">EMPRESA</th>
...
<jsp:include page="components/foot.jsp">
    <jsp:param  name="js" value="<script src=\"../../public/js/evaluador.js\"></script>"/>
</jsp:include>