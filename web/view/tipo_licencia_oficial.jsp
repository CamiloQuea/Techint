    ...
    <div class="p-2 mb-auto">
        <div class="d-flex mb-3">
            <h2 class="fw-light fs-4">
                Tipos de licencia oficial
            </h2>

            <h2 class="fw-light fs-6 ms-auto">
                /Licencia/Tipos de licencia oficial
            </h2>
                ...
                <table class="table mx-auto container-fluid" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" onclick="sortTable(2)">ID PAIS</th>
                            <th scope="col" onclick="sortTable(3)">PAIS</th>
...
<jsp:include page="components/foot.jsp">
    <jsp:param  name="js" value="<script src=\"../../public/js/tipo_licencia_oficial.js\"></script>"/>
</jsp:include>