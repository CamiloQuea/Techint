                ...
                <table class="table mx-auto container-fluid" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" onclick="sortTable(1)">TIPO VEHICULO</th>
                            <th scope="col" onclick="sortTable(1)">PLACA</th>
                ...
                <div class="modal-body mb">
                    ...
                    <div class="row g-3">
                        <div class="form-floating mb-3 col">
                            ...
                            <input type="text" class="form-control"  placeholder="Ingresar nombre" name="placa"></input>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <select class="form-select" name="tipoVehiculo_id" id="select_tipo_vehiculo">
...
<jsp:include page="components/foot.jsp">
    <jsp:param  name="js" value="<script src=\"../../public/js/vehiculo.js\"></script>"/>
</jsp:include>