                ...
                <table class="table mx-auto container-fluid" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" onclick="sortTable(1)">CODIGO</th>
                            <th scope="col" onclick="sortTable(2)">USUARIO ID</th>
                            <th scope="col" onclick="sortTable(3)">DETALLE</th>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="form-floating mb-3 col">
                            ...
                            <input type="text" class="form-control"  placeholder="Ingresar nombre" name="codigo">
                    ...
                    <div class="row g-3">
                        <div class="form-floating mb-3 col">
                            ...
                            <input type="text" class="form-control"  placeholder="Ingresar nombre" name="nombre"></input>
                    ...
                    <div class="row g-3">
                        <select class="form-select" id="select_usuario">
...
<jsp:include page="components/foot.jsp">
    <jsp:param  name="js" value="<script src=\"../../public/js/proyecto.js\"></script>"/>
</jsp:include>